...
class PrivacyEngine:
    ...
    def _prepare_data_loader(
        ...
        *,
        ...
        if not disable_poisson_sampling:
    ...
    def make_private(
        ...
        *,
        ...
        batch_first: bool = True,
        loss_reduction: str = "mean",
        disable_poisson_sampling: bool = True,
        clipping: str = "flat",
        noise_generator=None,
        grad_sample_mode: str = "hooks",
        ...
        if not disable_poisson_sampling:
            ...
            data_loader = self._prepare_data_loader(
                data_loader, distributed=distributed, disable_poisson_sampling=disable_poisson_sampling
            )

            sample_rate = 1 / len(data_loader)
            expected_batch_size = int(len(data_loader.dataset) * sample_rate)
        else:
            sample_rate = config.batch_size / config.data_size
    ...
    def make_private_with_epsilon(
        ...
        **kwargs,
        ...
        return self.make_private(
            ...
            noise_generator=noise_generator,
            grad_sample_mode=grad_sample_mode,
            disable_poisson_sampling=disable_poisson_sampling,
            clipping=clipping,
        )
